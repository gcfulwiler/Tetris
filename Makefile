...
OFILES = mylib.o home.o j.o l.o long.o main.o square.o t.o topleft.o topright.o font.o start.o blank.o ghost.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h j.h l.h long.h square.h t.h topleft.h topright.h font.h start.h blank.h ghost.h
